 ...
 * @date 2018/8/18
 */
public class DeliveryTaskAdapter extends MyBaseQuickAdapter<DeliveryTaskDataDown.ListBean> {
    Context context;
    List<DeliveryTaskDataDown.ListBean> list;
    ...
    public DeliveryTaskAdapter(int layoutResId, @Nullable List<DeliveryTaskDataDown.ListBean> data,Context context) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, DeliveryTaskDataDown.ListBean item) {
